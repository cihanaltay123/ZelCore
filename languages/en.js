export default {
  message: {
    ...
    // Close Dialog
    log_out: "Log Out",
    exit_zelcore: "Çıkış ZelCore",
    select_action: "Gerçekleştirilecek eylemi seçin",
    exit_full_node: "Tam düğümden çık",
    ...
    zel_id_sign_a_message: "Zel ID - Bir mesaj İle imzala",
    zel_id_disable_d2fa: "Zel ID - Devre dışı d2FA",
    ...
    sign_message_button: "İşaret mesajı",
    set_up_easy_login: "Kolay Giriş Kurulumu",
    verify_easy_login: "Kolay Giriş ifadesini doğrula",
    easy_login_bio: "Kolay Giriş, seçtiğiniz parola veya biyometrik ile hesabınıza giriş yapmanızı sağlar. D2FA etkinleştirilmemişse, Kolay Giriş özelliğini etkinleştirebilirsiniz.",
    disable_easy_login: "Kolay Girişi Devre Dışı Bırak",
    only_one_account_easy: "Zel ID Kolay Giriş ile yalnızca bir yerel hesap eşleştirilebilir. Bu işlem başka bir hesap için Kolay Giriş seçeneğini devre dışı bırakabilir. Kolay Giriş seçeneğini devre dışı bırakmak istediğinize emin misiniz?",
    disable_d2fa: "Devre dışı d2FA",
    set_up_d2fa: "Kurmak d2FA",
    ...
    used_for_security: "İşlem yapma, Özel Anahtarları ve Zel ID işlemlerini görüntüleme gibi güvenli görevler için kullanılır",
    used_for_logging: "Giriş yapmak için kullanılır ZelCore",
    decentralized_two_factor_authentication: "Dağıtılmış iki faktörlü Kimlik Doğrulama",
    create_or_change_pin: "D2FA PIN'inizi oluşturun veya değiştirin",
    disable_your_d2fa: "D2FA'nızı devre dışı bırakın",
    d2fa_requires_minimum: "Bir d2FA işlemi yayınlamak için cüzdanınızda bulunması gereken minimum 0.0002 ZEL gerekir. İşlem onaylandıktan ve hesap yeniden girildikten sonra değişiklikler gerçekleştirilir.",
    d2fa_adds_another_layer: "d2FA başka bir koruma ve güvenlik katmanı ekler. Bu değiştirilebilir PIN olmadan hesabınızla ilgili güvenlik görevlerini imzalayamaz veya gerçekleştiremezsiniz. PIN, doğrudan blok zinciri üzerinde şifrelenmiş bir biçimde saklanır. \n"
    + "No one except you can modify your d2FA signature!",
    create_or_change_easy: "Kolay Giriş Oluşturma veya değiştirme",
    signing_address: "İmza adresi:",
    signature: "İmza:",
    sign: "İmzala",
    sign_and_send: "İmzala ve Gönder",
    new_pin: "Yeni pin",
    easy_login_text: "Zel ID Kolay Giriş, seçtiğiniz cümleyi, pin kodunu, parmak izini veya Face ID'yi kullanarak bir hesaba hızlı şekilde giriş yapmak için yerel olarak depolanmış bir seçenek sunar. Kolay Giriş, d2FA'nın hesabınızda etkinleştirilmesini gerektirir ve yalnızca bir hesap için etkinleştirilebilir!",
    easy_login_disabled: "Kolay Giriş devre dışı",
    easy_sign_phrase: "Geçersiz Kolay İşaret ifadesi",
    easy_login_phrase_no_match: "Kolay Giriş ifadeleri eşleşmiyor",
    easy_login_activated: "Kolay Giriş etkin",
    ...
    login_to_account: "Hesaba giriş yapın",
    account_exist: "Hesap {Kullanıcı adı} zaten var!",
    account_registered: "Hesap {kullanıcı adı} kayıtlı",

    // account warning
    password_is_key: "Şifreniz, fonlarınıza erişmenin anahtarıdır, mümkün olduğu kadar güçlü kılın ve saklayın !",
    no_keep_copy: "ZelCore, şifrelenmemiş şifrenizin bir kopyasını yerel olarak veya uzaktan tutmaz. Bu özellik nedeniyle şifreyi almanın ya da değiştirmenin bir yolu yoktur. şifrenizi kayıt etmeyi unutmayın \n"
    + "Kullanıcı adınızı veya şifrenizi kaybederseniz (veya unutursanız), cüzdanınıza erişimi kaybedersiniz. Bu nedenle bilgilerinizin bir kopyasını güvenli bir yerde saklamanız ÇOK ÖNEMLİ ve ZORUNLUdur.",
    ...
    im_aware_register: "Farkındayım, Kayıt!",

    // landingpage.vue
    start_by: "Yerel olarak bir hesap açarak başlayın",
